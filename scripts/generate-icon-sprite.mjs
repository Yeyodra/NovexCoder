 ...
 * for all Ri* icons used in src/, and writes
 * src/components/icon/sprite.ts.
 */
...
for (const file of allSrcFiles) {
  ...
  // Also scan for icon: 'kebab-name' in object literals
...
const outPath = resolve(repoRoot, "src/components/icon/sprite.ts")
